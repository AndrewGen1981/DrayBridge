...
// async function getContainers(login) {
//     const content = await fetchWUT(
//         "http://tns.uswut.com/uiArp02Action/searchContainerInformationListByCntrNo.do",
//         {
//             method: "POST",
//             headers: {
//                 "Content-Type": "application/x-www-form-urlencoded"
...
//                 "blFlg": "N",
//                 "srchTpCd":	"C",    // (тип пошуку — контейнер)
//                 "cntrNo": "KKFU7919878,ONEU5625131",
//             })
//         }
//     )
...
//     // знаходимо JS масив result
//     const match = html.match(/var result\s*=\s*(\[.*?\]);/s);
//     if (!match) throw new Error("Cannot find result");
...
// async function test() {
//     await loginWUT("LONGROAD", "CRIULENI20")
//     await isSessionAlive()
//     await getContainers("LONGROAD")
// }
